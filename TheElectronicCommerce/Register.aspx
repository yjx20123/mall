<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="TheElectronicCommerce.Register" %>
						...
						<table  id="tabAddMenber"  runat =server style ="font-size :9pt">
                            ...
                            <tr>
                                ...
                                <td style="height: 24px" align="left">
                                    <asp:textbox id="txtEmail" runat="server"  MaxLength="80"></asp:textbox>&nbsp;<asp:RegularExpressionValidator ID="revEmail" runat="server" ControlToValidate="txtEmail"
