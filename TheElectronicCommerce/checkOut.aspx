<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="checkOut.aspx.cs" Inherits="TheElectronicCommerce.checkOut" %>
					...
					<table cellSpacing="0" cellPadding="0" width="95%" align="center" border="0" style="FONT-SIZE: 9pt">
						...
						<tr style =" font :9pt; font-family :宋体;">
								...
								<asp:ListItem>请选择配送方式及运输费用</asp:ListItem>
                                    <asp:ListItem Value="10">顺丰快递（10元）</asp:ListItem>
                                    <asp:ListItem Value="20">京东快递（20元）</asp:ListItem>
                                    <asp:ListItem Value="0">免费送货</asp:ListItem>
                                </asp:DropDownList></td>
							</tr>
							<tr style =" font :9pt; font-family :宋体;">
								...
								<FONT color="red">
									<asp:RequiredFieldValidator ID="rfvReciverName" runat="server" ControlToValidate="txtReciverName" Font-Size="9pt"
                                        Height="1px" Width="1px">
									</asp:RequiredFieldValidator></FONT></td>	
							</tr>
							<tr style =" font :9pt; font-family :宋体;">
