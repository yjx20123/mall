<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Left.aspx.cs" Inherits="TheElectronicCommerce.Manage.Left" %>
				...
				<td>
					<div class="sec_menu" id="menu5" style="WIDTH: 158px">
						<table cellSpacing="0" cellPadding="0" width="140" align="center">
							...
							<tr>
								<td style="height: 20px"><A href="imagery.aspx" target="right">上传管理</A></td>
							</tr>
						</table>
					</div>
				</td>
